...
KPI_INFO = {
    "Что такое KPI": (
        "📊 *KPI* — это конкретная цифра или метрика, по которой оценивают, "
        "насколько хорошо ты справляешься со своей работой. "
        "Это как цель + цифра, по которой можно понять: достигнута задача или нет.\n\n"
        "💡 Или, как сказал *Питер Друкер*: _«То, что измеряется — улучшается»_."
    ),
    "Как писать": (
        "✍️ Пиши задачи по *SMART* — это чётко сформулированные цели, которые:\n"
        "• конкретны\n"
        "• измеримы\n"
        "• достижимы\n"
        "• релевантны\n"
